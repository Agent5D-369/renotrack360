...
if (!['access', 'media', 'reports', 'pricing', 'work-items', 'cost-sources', 'payments', 'financial-review', 'homewyse'].includes(suite)) throw new Error('Unknown disposable test suite.');

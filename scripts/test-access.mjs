...
if (!['access', 'media', 'reports', 'pricing', 'work-items', 'cost-sources', 'payments', 'financial-review', 'homewyse', 'work-packages', 'estimate-acceptance', 'milestone-billing'].includes(suite)) throw new Error('Unknown disposable test suite.');
